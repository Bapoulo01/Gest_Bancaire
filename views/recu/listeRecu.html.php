    ...
    <div class="container-fluid col-12 d-flex vh-100 ">
          ...
          ?>
            ...
            <div class="container col-10 border">
                <div class="container col-10 mt-3 border shadow d-flex align-items-center justify-content-around p-3 rounded">
                    <div class="col-md-3 d-flex align-items-center">
                        <label for="inputCity" class="form-label  mx-2">Ref</label>
                        <input type="text" class="form-control" id="inputTel">
                    </div>
                    <div class="col-md-3 d-flex align-items-center mx-2">
                        <label for="inputCity" class="form-label  mx-2">Date</label>
                        <input type="date" class="form-control" id="inputTel">
                    </div>
                    <div class="col-md-3 d-flex align-items-center mx-2">
                        <label for="inputCity" class="form-label  mx-2">Type</label>
                ...
                <div class="container rounded-3 col-12  mt-5  shadow p-1  rounded">
                    <table class="table">
                        ...
                        <?php foreach ($datas as $data):?>
                            <tr>
                                <td class="col"><?=$data->reference?></td>
                                <td class="col"><?=$data->dater?></td>
                                <td class="col"><?=$data->type?></td>
                                <td class="col"><?=$data->montant?></td>
                            </tr>             
                        <?php endforeach;?>                        
                        </tbody>
                    </table>
